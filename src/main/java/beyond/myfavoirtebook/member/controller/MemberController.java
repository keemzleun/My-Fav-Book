package beyond.myfavoirtebook.member.controller;

import beyond.myfavoirtebook.common.auth.JwtTokenProvider;
...
//    }
    ...
    public ResponseEntity<?> generateNewAccessToken(@RequestBody MemberRefreshDto dto){
        ...
        String newAt = jwtTokenProvider.createToken(email);
