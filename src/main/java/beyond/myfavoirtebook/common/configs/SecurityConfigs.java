package beyond.myfavoirtebook.common.configs;

import beyond.myfavoirtebook.common.auth.JwtAuthFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeRequests()    // 어떤 urL 패턴에서 로그인을 안 할 것인지
                    .antMatchers("/member/create", "/", "/doLogin", "/refresh-token", "/email/requestCode", "/book/search")
                    .permitAll()
